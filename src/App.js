    ...
    <div className="container">
      ...
      <div className="main-page">
              ...
              return (
                <tr className="tr" key={dataObj._id}>
                  ...
                  <td className="td td5">
                    ...
                    {full !== truncated && (
                      <button className="btn-showmore" onClick={() => handleToggleBio(index)}>
        ...
        <div className="pagination">
          <button className="paging-button" onClick={handlePrevPage} disabled={currentPage === 1}>
            Previous
          </button>
          <span>Page {currentPage}</span>
          <button className="paging-button" onClick={handleNextPage} disabled={currentPage === Math.ceil(filteredData.length / itemsPerPage)}>
            Next
          </button>
        </div>
      </div>
